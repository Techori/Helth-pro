...
import ThreeDRiLogo from "@/components/ThreeDRiLogo";
      ...
      <div className="container mx-auto px-4 sm:px-6 relative">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            <div
              className={`w-full lg:w-1/2 space-y-6 sm:space-y-8 text-center lg:text-left transition-all duration-700 ${
                isLoaded
            ...
            >
              ...
              <h1 className="font-display font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-tight text-gray-900 leading-tight">
                <span className="text-brand-600">Healthcare</span> Made{" "}
                <span className="text-medicare-500">Accessible</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-xl mx-auto lg:mx-0">
                Get medical treatment today, pay later! With flexible EMI plans
                and instant approvals, we make healthcare accessible for
                everyone.
              </p>
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 md:gap-6 justify-center lg:justify-start">
                <Link to="/apply-loan" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-brand-600 hover:bg-brand-700 text-base flex items-center gap-2 group"
                  >
                    Apply Now
                ...
                <Link to="/hospital-registration" className="w-full sm:w-auto">
                  <Button
                    variant="outline"
                    size="lg"
                    className="w-full sm:w-auto text-base flex items-center gap-2 group border-medicare-500 text-medicare-500 hover:bg-medicare-500 hover:text-white"
                  >
                    Get Started
            ...
            <div
              className={`w-full lg:w-1/2 relative transition-all duration-700 delay-300 ${
                isLoaded
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
