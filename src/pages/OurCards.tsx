...
import ThreeDHealthCard from "@/components/ThreeDHealthCard";
  ...
  const cards = [
    {
      ...
      title:
        "Get medical treatment now and pay later with 0% interest for the first 3 months!",
      annualFee: "₹4,720",
      hospitals: "500+",
    ...
    },
    {
      ...
      title:
        "Convert your medical expenses into affordable monthly installments!",
      annualFee: "₹4,720",
      hospitals: "500+",
    ...
    },
    {
      ...
      title:
        "Enjoy instant discounts and benefits on all your medical expenses!",
      annualFee: "₹1,770",
      hospitals: "500+",
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-6">
                Get medical treatment first, pay later with flexible payment
                options
              </p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="max-w-4xl mx-auto">
                  ...
                  >
                    <div
                      className={`rounded-xl overflow-hidden relative ${
                        selectedCard === card.id
                          ? "ring-2 ring-offset-2 ring-" + card.accent + "-500"
                          : "ring-1 ring-gray-200"
                      }`}
                    >
                      <div
                        className={`h-3 bg-gradient-to-r ${card.color}`}
                      ></div>
              ...
              {selectedCardData && (
                <div
                  className={`animate-fade-in bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden ${
                    selectedCardData.id === selectedCard ? "" : "hidden"
                  }`}
                >
                  <div
                    className={`h-2 bg-gradient-to-r ${selectedCardData.color}`}
                  ></div>
                  <div className="p-8">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="p-3 w-full">
                              <ThreeDHealthCard
                                ...
                                cardColor={
                                  selectedCardData.accent === "brand"
                                    ? "#e67817"
                                    : selectedCardData.accent === "medicare"
                                    ? "#6366f1"
                                    : selectedCardData.accent === "purple"
                                    ? "#8b5cf6"
                                    : "#10b981"
                                }
                                holderName="Health Card Holder"
                              />
                            </div>
                          </div>
                        </div>
                        <div className="space-y-3 mb-6">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {selectedCardData.annualFee}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Hospitals:</span>
                            <span className="font-medium">
                              {selectedCardData.hospitals}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {selectedCardData.documentation}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Approval:</span>
                            <span className="font-medium">
                              {selectedCardData.approval}
                            </span>
                          </div>
                        </div>
                        <Link to="/apply-loan">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="overflow-x-auto">
                <table className="w-full min-w-[800px] bg-white rounded-lg shadow-sm border border-gray-100">
                  <thead>
                    <tr>
                      <th className="p-4 text-left text-gray-900 font-medium">
                        Features
                      </th>
                      {cards.map((card) => (
                        <th
                          key={card.id}
                          className="p-4 text-left text-gray-900 font-medium"
                        >
                          {card.name}
                        </th>
                      ))}
                  ...
                  <tbody>
                    <tr className="border-t border-gray-100">
                      ...
                      {cards.map((card) => (
                        <td key={card.id} className="p-4 font-medium">
                          {card.annualFee}
                        </td>
                      ))}
                    </tr>
                    ...
                    <tr className="border-t border-gray-100">
                      ...
                      <td className="p-4 font-medium">
                        0% for 3 months, then 12-18%
                      </td>
                      <td className="p-4 font-medium">12-18% p.a.</td>
                      <td className="p-4 font-medium">
                        0% if paid within term, then 12-18%
                      </td>
                      <td className="p-4 font-medium">N/A</td>
                    </tr>
                    <tr className="border-t border-gray-100 bg-gray-50">
                    ...
                    <tr className="border-t border-gray-100 bg-gray-50">
                      ...
                      <td className="p-4 font-medium">
                        Moderate treatments with split payments
                      </td>
                      <td className="p-4 font-medium">
                        Regular hospital visits with instant savings
                      </td>
                    </tr>
                    <tr className="border-t border-gray-100">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6">
                {[
                  {
                    question:
                      "Who is eligible for RI Medicare healthcare cards?",
                    answer:
                      "Any Indian resident aged 21-65 years with a valid ID proof, address proof, and having a regular income source (salaried or self-employed) can apply for our healthcare cards.",
                  },
                  {
                    question: "How long does the approval process take?",
                    answer:
                      "Our digital KYC and verification process enables instant approvals in most cases. Once approved, you can immediately use your digital card at any of our partner hospitals.",
                  },
                  {
                    question: "Is there any processing fee?",
                    answer:
                      "There is no processing fee for applying for our healthcare cards. The only charge is the annual fee which is clearly mentioned for each card type.",
                  },
                  {
                    question:
                      "Can I use the card for my family members' treatment?",
                    answer:
                      "Yes, you can use your RI Medicare card for medical treatments of your immediate family members (spouse, children, and parents).",
                  },
                  {
                    question: "What happens if I miss an EMI payment?",
                    answer:
                      "Late payment fees and additional interest will be applicable if you miss an EMI payment. We recommend setting up auto-debit to avoid missing payments.",
                  },
                  {
                    question: "How can I check my available credit limit?",
                    answer:
                      "You can check your available credit limit through the RI Medicare mobile app or by logging into your account on our website.",
                  },
                ].map((faq, index) => (
                  <div
                    key={index}
          ...
          <div className="container mx-auto px-4 sm:px-6 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                No more financial worries for your medical treatments. Apply for
                an RI Medicare card and experience stress-free healthcare
                financing.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/apply-loan">
                  <Button
                    size="lg"
                    variant="default"
                    className="w-full sm:w-auto bg-white hover:bg-gray-100 text-brand-600"
                  >
                    Apply Now
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                ...
                <Link to="/about-us">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full sm:w-auto text-white hover:bg-white/10 border-white"
                  >
                    Learn More
